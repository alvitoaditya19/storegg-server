...
let transactionSchema = mongoose.Schema(
  {
    ...
    historyUser: {
      name: { type: String, require: [true, "nama palyer harus diisi."] },
      phoneNumber: {
        type: Number,
        require: [true, "nama harus diisi"],
        maxlength: [9, "panjang nama harus antara 9-13 karakter"],
        minlength: [3, "panjang nama harus antara 9-13 karakter"], 
      },
    },
    category: {
      type: mongoose.Schema.Types.ObjectId,
